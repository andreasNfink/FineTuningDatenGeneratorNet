...
1. **Endpunkt-Name:** Geben Sie einen eindeutigen, technischen Namen für den Endpunkt ein. Dieser wird Teil der URL.
   ...
   * Die resultierende URL wird etwa so aussehen: `https://:/data/MES_Turbine_Data`
...
1. Verwenden Sie ein externes Tool wie `Postman`, `curl` oder ein Testskript, um einen HTTP PUT-Request an die Endpunkt-URL zu senden (z.B. `https://:/data/MES_Turbine_Data`).
